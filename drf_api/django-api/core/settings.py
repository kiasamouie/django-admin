...
SECRET_KEY = os.getenv('SECRET_KEY', default='insecure-S#perS3crEt_007')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = int(bool(os.getenv("DEBUG", default=0)))
...
DATABASES = {
    "default": {
        ...
        "NAME"    : os.getenv("DB_DATABASE", default=os.path.join(BASE_DIR, "db.sqlite3")),
...
CORS_ALLOWED_ORIGINS_ENV = os.getenv("CORS_ALLOWED_ORIGINS", default=None)
